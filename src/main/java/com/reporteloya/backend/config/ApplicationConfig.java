    ...
    public CommandLineRunner createAdminUser(PasswordEncoder passwordEncoder) {
        return args -> {
            ...
            try {
                ...
                System.out.println(">>> Usuario ADMIN ya existe, omitiendo <<<");
            }
            ...
            try {
                ...
                System.out.println(">>> Agente agente@transito.com creado correctamente <<<");
            } catch (DataIntegrityViolationException e) {
                System.out.println(">>> Agente agente@transito.com ya existe, omitiendo <<<");
            }
            ...
            try {
                ...
                agente.setEstado("disponible");
                agenteRepository.save(agente);
                System.out.println(">>> Agente agente@transito2.com creado correctamente <<<");
            } catch (DataIntegrityViolationException e) {
                System.out.println(">>> Agente agente@transito2.com ya existe, omitiendo <<<");
            }
        };
    }
